...
public class UISkinShop : MonoBehaviour
{
    ...
    [SerializeField] private UISkin skinPrefab;
    [SerializeField] private Transform skinParent; //scrollview의 content (스킨 ui의 부모)
    [SerializeField] private TextMeshProUGUI textStarCount; //별 개수 출력 UI
    ...
    private void OnEnable()
    {
        ...
        */
        ...
        //현재 소유한 모든 스톤 UI의 색상을 notSelectedColor로 설정
        for(int i = 0; i < skinCount; i++)
        {
